...
describe('SEO Component', () => {
  ...
  it('handles very long title', () => {
    const longTitle = 'This is a very long title that exceeds normal character limits and should still render correctly without breaking the page layout or causing any issues'
