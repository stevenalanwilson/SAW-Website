...
```jsx
<PageHero title='About Me' subtitle='Welcome to my page' />
```
...
```jsx
<PageTitle title='My Blog Post' summary='A brief summary' date='2024-12-25' />
```
...
```jsx
<StatsCard title='Professional Network' stats={[{ label: 'Connections', value: '500+' }]} />
```
...
```jsx
<ExpertiseGrid items={[{ title: 'Skill', description: 'Skill description' }]} />
```
...
```jsx
<SEO title='Page Title' description='Page description' url='https://example.com/page' />
```
