  ...
  content: {
    ...
    about: {
      ...
      currentRole: {
        ...
        description: 'Leading digital transformation initiatives, providing strategic technical guidance, and helping organizations leverage AI and modern technologies to solve complex business challenges.'
      }
    }
  },
  ...
  experience: [
    {
      ...
      description: 'Contributed to technical strategy and digital transformation initiatives for Ireland\'s leading airline.'
    },
    {
      company: 'PUBLIC',
    ...
    },
    {
      ...
      description: 'Delivered digital services for one of London\'s most innovative local authorities.'
    },
    {
      company: 'Ministry of Justice Digital',
      companyUrl: 'https://mojdigital.blog.gov.uk',
      title: 'Technical Leadership Role',
      description: 'Helped transform digital services across the justice system, working on critical government infrastructure.'
    }
  ],
